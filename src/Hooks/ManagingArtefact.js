...
const ManagingArtefact = () => {
  ...
  const url = "http://34.88.237.151:3000/artifacts/getAllArtifacts";
  ...
  return {
    ...
    handleArtefact: () => {
      axios
        .post("http://34.88.237.151:3000/artifacts/postArtifact", artefact)
        .then((response) => {
    ...
    handleDeleteArtefact: (name) => {
      axios
        .delete(`hhttp://34.88.237.151:3000/artifacts/deleteArtifact/${name}`)
        .then((response) => {
          console.log(response.data);
